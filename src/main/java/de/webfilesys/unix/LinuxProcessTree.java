...
{
    private static final Logger logger = LogManager.getLogger(LinuxProcessTree.class);
    ...
    protected void readProcessList()
    {
        ...
        prog_name_parms[2]="ps -eo user,pid,ppid,sz,tty,cputime,start_time,command --cols 120" + " 2>&1";
