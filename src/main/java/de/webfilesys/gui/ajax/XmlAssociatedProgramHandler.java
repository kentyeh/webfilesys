...
{
    private static final Logger logger = LogManager.getLogger(XmlAssociatedProgramHandler.class);
	...
	protected void process()
	{
        ...
        else
        {
            ...
            {
                logger.error("cannot start associated program " + assocProg + " for " + filePath + ": " + e);
                XmlUtil.setChildText(resultElement, "success", "false");
                XmlUtil.setChildText(resultElement, "message", 
