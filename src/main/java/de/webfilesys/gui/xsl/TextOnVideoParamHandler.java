 ...
 */
public class TextOnVideoParamHandler extends XslRequestHandlerBase {
    private static final Logger logger = LogManager.getLogger(TextOnVideoParamHandler.class);
	
	public TextOnVideoParamHandler(
	...
	protected void process() {
		...
		ProcessingInstruction xslRef = doc.createProcessingInstruction("xml-stylesheet", "type=\"text/xsl\" href=\""+ req.getContextPath() +"/xsl/textOnVideoParams.xsl\"");
		...
		processResponse("textOnVideoParams.xsl");
    }
}