...
public class PublishMailRequestHandler extends UserRequestHandler
{
	...
	protected void process()
	{
		...
		*/
		...
		if (invitationType.equals(InvitationManager.INVITATION_TYPE_TREE))
		{
			if ((publishType != null) && publishType.equals("album"))
			{
				secretURL.append(""+ req.getContextPath() +"/visitor/");
			...
			{
				secretURL.append(req.getContextPath() + "/servlet?command=silentLogin&");
				secretURL.append(virtualUser);
				secretURL.append('=');
				secretURL.append(accessCode);
			}
		...
		{
			secretURL.append(req.getContextPath() + "/servlet?command=public&accessCode=");
		...
		output.println("<script src=\""+ req.getContextPath() +"/javascript/publish.js\" type=\"text/javascript\"></script>");
	...
	{	
		...
		output.println("<script src=\""+ req.getContextPath() +"/javascript/fmweb.js\" type=\"text/javascript\"></script>"); 
		output.println("<script src=\""+ req.getContextPath() +"/javascript/publish.js\" type=\"text/javascript\"></script>"); 
		...
		output.println("<form accept-charset=\"utf-8\" name=\"form1\" method=\"post\" action=\""+ req.getContextPath() + "/servlet\">");
